...
const Counter = (props) => {
  ...
  //7. This is the actual onClick function that runs every time you press
  //the button
  ...
  //8. It's our api call shoved into a useEffect! I did it this way so
  //that if I wanted to put the onLoad function in a seperate file at
  //some point, it would be easier.

  return (
    <div className="counter">
      <button className={press === true ? "increased" : "increase"} onClick={onClickIncrease}>
...
//9. Ahhhh finally the JSX. commaNumber is a dependancy I installed to
